...
export const themeSchema: HydrogenThemeSchema = {
  info: {
    version,
    author: "SMEETA PANNAKAR (BCA, GFGC Dharwad) U02AJ23S0440",
    name: "PROJECT BY SMEETA",
    authorProfilePhoto: "",
    documentationUrl: "",
    supportUrl: "",
  },
    ...
    },
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          label: "Store bio",
          defaultValue:
            "<p>This website is created and maintained by SMEETA PANNAKAR, a BCA student at Government First Grade College, Dharwad. We are dedicated to providing excellent service and quality products.</p>",
        },
        {
          type: "heading",
          label: "Social links",
        ...
        },
        {
          ...
          name: "storeEmail",
          label: "Email",
          defaultValue: "smithapannakar704@gmail.com",
        ...
        },
        {
          ...
          defaultValue: "© 2026 SMEETA PANNAKAR. All rights reserved.",
        },
      ],
    },
  ],
